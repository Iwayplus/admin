...
class Fingerprinting{
  ...
  Future<List<Beacon>> fetchBeaconData(Map<String, beacon>? apibeaconmap) async {
    ...
    print("beaconvalues ${beaconvalues} ${apibeaconmap}");
